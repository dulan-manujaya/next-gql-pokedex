...
export type GetPokemonByNameQuery = { __typename?: 'Query', getPokemon: { __typename?: 'Pokemon', num: number, species: string, color: string, sprite: string, levellingRate?: string | null, bulbapediaPage: string, baseSpecies?: string | null, types: Array<{ __typename?: 'PokemonType', name: string }>, baseStats: { __typename?: 'Stats', attack: number, defense: number, hp: number, speed: number, specialdefense: number, specialattack: number }, gender: { __typename?: 'Gender', female: string, male: string }, flavorTexts: Array<{ __typename?: 'Flavor', flavor: string, game: string }> } };
